...
* In the `seed-cli` module, for [command-line applications]({{< ref "docs/cli" >}}).
* In the `seed-web-undertow`, for [Web applications]({{< ref "docs/web" >}}) embedding their own server.
...
See [this page]({{< ref "docs/web#in-a-container" >}}) for more information.
{{% /callout %}} 
