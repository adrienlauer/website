---
title: "13. In-memory persistence"
subsection: "tutorial"    
tags:
...
done with [Repositories]({{< ref "docs/business/behavior/repositories.md" >}}) which work on whole aggregates.<!--more--> 
...
`HelloResource`. We will combine it with the service we defined [before]({{< ref "learn/tutorial/business.md#the-greeter-service" >}}):
...
is done in a custom repository interface, with a [specification]({{< ref "docs/business/model/specifications.md" >}}).
...
* How to configure and use in-memory persistence emulation.

If everything looks good, continue to the [next page]({{< ref "persistence-jpa.md" >}}).
